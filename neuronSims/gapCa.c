...
#define gapCaP	*_ppvar[5]._pval
#define _p_gapCaP	_ppvar[5]._pval
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 7, 7);
 	hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 GapCa D:/Dropbox/Dropbox/AsrocyteModel/nano/neuronSims/gapCa.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ...
   ica = ( 1e+16 ) * ( ( ( cai - 50e-6 ) / fluxion ) * ( 2.0 * FARADAY ) ) ;
   }
 _current += icagap;
 _current += ica;
